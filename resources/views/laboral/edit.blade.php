...
@section('navigation')
<h2 class="page-title ">Editar Regimen Laboral</h2>
<div class="ms-auto text-end">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
            <li class="breadcrumb-item"><a href="{{ route('laborales.index') }}">Regimenes Laborales</a></li>
...
@section('content')
<div class="container">
    <form action="{{ route('laborales.update', ['laborale'=>$laboral]) }}" method="post">
        @method('PATCH')
        @csrf
            ...
            <div class="row g-3">
                <div class="col-md-12 requerido">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" maxlength="100"
                        value="{{old('nombre', $laboral->tipo_regimene)}}" autocomplete="off">
                    @error('nombre')
                ...
                <div>
                    <div class="border-top">
                        ...
                        <a href="{{ route('laborales.index') }}"><button type="button"
...
$(document).ready(function() {
    const li = document.getElementById("laboral-li");
    li.classList.add("sidebar-item");
    li.classList.add("selected");
    const a = document.getElementById("laboral-a");
