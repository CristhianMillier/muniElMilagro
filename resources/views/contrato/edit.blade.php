...
@section('content')
<div class="container">
    <form action="{{ route('contratos.update', ['contrato'=>$contrato]) }}" method="post">
        @method('PATCH')
        @csrf
            ...
            <div class="row g-3">
                <div class="col-md-12 requerido">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" maxlength="100"
                        value="{{old('nombre', $contrato->nombre)}}" autocomplete="off">
                    @error('nombre')
                ...
                <div>
                    <div class="border-top">
                        ...
                        <a href="{{ route('contratos.index') }}"><button type="button"
...
$(document).ready(function() {
    const li = document.getElementById("contrato-li");
    li.classList.add("sidebar-item");
    li.classList.add("selected");
    const a = document.getElementById("contrato-a");
